...
(
	CODICE_STRUTTURA_ORGANIZZATIVA VARCHAR(20) primary key,
	DESCRIZIONE_STRUTTURA_ORGANIZZATIVA_B VARCHAR(20),
	DESCRIZIONE_STRUTTURA_ORGANIZZATIVA_R VARCHAR(100),
	NUMERO_ORDINE VARCHAR(20)
);
